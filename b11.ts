...
class Book2 {
    constructor(public id: number, public title: string, public stock: number, public status: string) {}
}

class Member1 {
    private books: LendedBook1[] = [];

    borrowBook(bookId: number, libraryBooks: Book2[]) {
    ...
    returnBook(bookId: number, libraryBooks: Book2[]) {
